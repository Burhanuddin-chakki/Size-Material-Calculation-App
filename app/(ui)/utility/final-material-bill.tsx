...
export default function FinalMaterialBill({ materialEstimationDetail }: { materialEstimationDetail: MaterialEstimation[] }) {
    return <>
                ...
                {materialEstimationDetail && <table className="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style={{ textAlign: 'center' }}>Material (Type)</th>
                    ...
                    <tbody>
                        {
                            ...
                            materialEstimationDetail.map((material, index) =>
                                ...
                                <tr key={`${index}`}>
                                    ...
                                    <th>{material.materialName} {material.type ? `(${material.type})` : ""}</th>
