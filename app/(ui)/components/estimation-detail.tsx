...
import { calculateMaterialTotalAmount, handleMaterialFunction } from "../services/material.service";
...
export default function MaterialPrice({ materialList, windowType, inputData }: MaterialPriceProps) {
    ...
    const showExtraPipeColumn = useMemo((): boolean => {
        return Object.values(trackEstimationDetail).some(estimation => estimation.extraPipeSize && estimation.extraPipeSize.length > 0);
    ...
    return <>
        ...
        <div className="row main-container">
            ...
            <FinalPipeBill trackEstimationDetail={trackEstimationDetail} showExtraPipeColumn={showExtraPipeColumn} />
            <br />
            {/* Final Material Bill Table */}
            <FinalMaterialBill materialEstimationDetail={materialEstimationDetail} />
        </div>
        <br />
        <div className="row main-container">
            <div className="row">
