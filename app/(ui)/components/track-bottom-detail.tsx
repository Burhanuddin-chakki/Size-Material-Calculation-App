...
export default function TrackBottomDetail(props: TrackBottomDetailProps) {
  ...
  useEffect(() => {
    const trackBottomPipeDetail = props.pipeDetail.find(
      (pd) => pd.pipeType === "Track Bottom",
    );
    setValue(
      "smallTrackBottomPipeWeight",
      trackBottomPipeDetail?.pipeSizes[0].weight || 0,
    );
    setValue(
        ...
        <div className="col-2">
          ...
          <div className="input-group mb-3">
            <input
              ...
              step="0.01"
              onWheel={(e) => e.currentTarget.blur()}
              {...register("smallTrackBottomPipeWeight", {
                valueAsNumber: true,
              })}
            />
          ...
          <div className="d-flex flex-column">
            <div className="form-check">
              ...
              <label
                ...
                htmlFor="trackBottomPipeSize180"
              >
                180"
              </label>
            </div>
            <div className="form-check">
              ...
              <label
                className="form-check-label"
                htmlFor="trackBottomPipeSize192"
              >
                192"
              </label>
            </div>
